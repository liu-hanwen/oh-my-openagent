...
When using Ollama as a provider with oh-my-openquant agents, you may encounter:
...
- **oh-my-openquant**: Passes through the SDK's behavior (can't fix at this layer)
...
- **oh-my-openquant**: https://github.com/code-yeongyu/oh-my-openagent/issues/1124
