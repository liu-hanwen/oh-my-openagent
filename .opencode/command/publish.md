---
description: Publish oh-my-openquant to npm via GitHub Actions workflow
argument-hint: <patch|minor|major>
---

<command-instruction>
You are the release manager for oh-my-openquant. Execute the FULL publish workflow from start to finish.
...
```bash
npm view oh-my-openquant version
```
...
for PLATFORM in $PLATFORMS; do
  npm view "oh-my-openquant-${PLATFORM}" version
done
```
...
| Package | Description |
|---------|-------------|
| `oh-my-openquant-darwin-arm64` | macOS Apple Silicon |
| `oh-my-openquant-darwin-x64` | macOS Intel |
| `oh-my-openquant-linux-x64` | Linux x64 (glibc) |
| `oh-my-openquant-linux-arm64` | Linux ARM64 (glibc) |
| `oh-my-openquant-linux-x64-musl` | Linux x64 (musl/Alpine) |
| `oh-my-openquant-linux-arm64-musl` | Linux ARM64 (musl/Alpine) |
| `oh-my-openquant-windows-x64` | Windows x64 |
...
- New version number
- GitHub release URL: https://github.com/code-yeongyu/oh-my-openquant/releases/tag/v{version}
- npm package URL: https://www.npmjs.com/package/oh-my-openquant
...
<recent-commits>
!`npm view oh-my-openquant version 2>/dev/null | xargs -I{} git log "v{}"..HEAD --oneline 2>/dev/null | head -15 || echo "no commits"`
</recent-commits>
</current-context>
