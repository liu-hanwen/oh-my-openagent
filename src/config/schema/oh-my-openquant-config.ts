...
export const OhMyOpenQuantConfigSchema = z.object({
  $schema: z.string().optional(),
  /** Enable new task system (default: false) */
  new_task_system_enabled: z.boolean().optional(),
  /** Default agent name for `oh-my-openquant run` (env: OPENCODE_DEFAULT_AGENT) */
...
export type OhMyOpenQuantConfig = z.infer<typeof OhMyOpenQuantConfigSchema>
