...
describe("loadJsonFile", () => {
  ...
  it("discovers JSONC-only user config (oh-my-openquant.jsonc)", () => {
  ...
  "lsp": {
    "user-jsonc": {
      ...
      const userPath = join(tempBase, "oh-my-openquant.jsonc")
  ...
  it("discovers JSONC-only project config (.opencode/oh-my-openquant.jsonc)", () => {
  ...
  "lsp": {
    "project-jsonc": {
      ...
      const projectPath = join(tempProject, ".opencode", "oh-my-openquant.jsonc")
  ...
  "lsp": {
    "conflict": {
      ...
      writeFileSync(join(tempBase, "oh-my-openquant.json"), jsonContent, "utf-8")
      writeFileSync(join(tempBase, "oh-my-openquant.jsonc"), jsoncContent, "utf-8")
