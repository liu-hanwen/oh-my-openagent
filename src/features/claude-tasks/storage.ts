...
import type { OhMyOpenQuantConfig } from "../../config/schema"

export function getTaskDir(config: Partial<OhMyOpenQuantConfig> = {}): string {
...
export function resolveTaskListId(config: Partial<OhMyOpenQuantConfig> = {}): string {
...
export function listTaskFiles(config: Partial<OhMyOpenQuantConfig> = {}): string[] {
